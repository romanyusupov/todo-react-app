...
export const posts = [
  ...
  },
  {
    ...
    title: "Статья 3",
    text: "Главным образом новая модель организационной деятельности требуют определения и уточнения модели развития. Не следует, однако забывать, что новая модель организационной деятельности играет важную роль в формировании новых предложений.",
  },
  {
    id: 4,
    imageUrl:
        ...
        <Col key={obj.id}>
          <Card>
            ...
            <Card.Body>
              ...
              <Card.Text>{obj.text.substr(0, 50)} ...</Card.Text>
            </Card.Body>
          </Card>
        </Col>
      ))}
